...
//Serial.println(analogRead(IRsensor1));
//Serial.print(" ");
//Serial.println(analogRead(IRsensor1));
//Serial.print(" ");
...
void calculerDistanceMinSensors(){
  float volts = max(analogRead(IRsensor0), max(analogRead(IRsensor1), max(analogRead(IRsensor1), analogRead(IRsensor1))))*0.0048828125;  // value from sensor * (5/1024)
